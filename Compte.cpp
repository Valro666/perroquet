...
Compte::Compte(string id , string pw,int type){
	...
	switch(type){
	case COMPTE_ETUDIANT : status = COMPTE_ETUDIANT; break;	

	case COMPTE_ENSEIGNANT : status = COMPTE_ENSEIGNANT; break;

	case COMPTE_ADMIN : status = COMPTE_ADMIN; break;

	default : status = 42; break;
